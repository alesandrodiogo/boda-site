...
$query = mysqli_query($connection->conn, "SELECT id_produto,id_vendedor,nome_produto,descricao_produto,preco_produto,data_create FROM produtos WHERE id_categoria=2 ORDER BY id_produto");
?>
