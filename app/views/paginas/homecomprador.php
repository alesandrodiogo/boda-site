...
$query = mysqli_query($connection->conn, "SELECT id_produto,id_vendedor,nome_produto,descricao_produto,preco_produto,data_create FROM produtos ORDER BY id_produto");
$query2 = mysqli_query($connection->conn, "SELECT id_produto,id_vendedor,nome_produto,descricao_produto,preco_produto,data_create FROM produtos WHERE preco_produto=200 ORDER BY id_produto");
?>
             ...
             <div>
                 ...
                 <?php
                      while($dados2 =mysqli_fetch_array($query2)){
                        ?>
                     <!--cards go here-->
                     <a href="<?=URL?>/paginas/visualizarproduto/&id=<?=$dados2['id_produto'];?>">
