<nav class="flex items-center p-3 flex-wrap fixed top-0 left-0 right-0" style="background-color: #04B3C8;">
 <a href="<?=URL?>/paginas/homecomprador" class="p-2 mr-3 inline-flex items-center">
 ...
 <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border rounded-md py-2 pl-2 shadow-sm focus:outline-none sm:text-sm" placeholder="Buscar serviços ou produtos" type="text" name="search"/>
   ...
   <a href="<?=URL?>/paginas/homecomprador" class="lg:inline-flex lg:w-auto px-3 py-2 rounded text-white hover:text-white hover:bg-teal-400"><span>Home</span></a>
   ...
   <a href="<?=URL?>/paginas/mensagens" class="lg:inline-flex lg:w-auto px-3 py-2 rounded text-white hover:text-white hover:bg-teal-400"><span><i class="fa-solid fa-comments"></i></span></a>
